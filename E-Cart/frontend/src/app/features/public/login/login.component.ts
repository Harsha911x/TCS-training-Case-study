          ...
          <form [formGroup]="loginForm" (ngSubmit)="onSubmit()">
            <div class="form-group">
              ...
              <div *ngIf="loginForm.get('email')?.hasError('required') && loginForm.get('email')?.touched" 
                   class="error-text">Enter your Email ID</div>
            </div>
            ...
            <div class="login-footer">
              <p>New to E-Cart? <a routerLink="/register">Create your account</a></p>
    ...
    if (this.loginForm.valid) {
      ...
      this.authService.loginCustomer(this.loginForm.value).subscribe({
        next: (response) => {
          ...
          this.successMessage = `Welcome ${response.customerName}!`;
          setTimeout(() => {
        ...
        error: (err) => {
          ...
          if (err.error?.message) {
            this.errorMessage = 'Invalid Email Id/Password.';
          } else {
            this.errorMessage = 'Invalid Email Id/Password.';
          }
        }
