  ...
  return (
    <Carousel>
      <Carousel.Item interval={1000} className={classes.item}>
        ...
        />
        <Carousel.Caption>
          <h3 ><strong style={{fontSize: '40px'}}>Fly to Qatar with StarJet Airline</strong></h3>
          <p>Be there at the Wordlcup 2022 with StarJet Airline and cheer your team to victory.</p>
        </Carousel.Caption>
      </Carousel.Item>
