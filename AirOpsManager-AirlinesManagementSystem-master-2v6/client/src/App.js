...
import BoardingPassView from "./components/Pages/BoardingPassView";
  ...
  return (
    <BrowserRouter>
        ...
        <Switch>
          ...
          <Route path='/SeatSelection/:clientId/:flightNo' component={SeatSelection}/>
          <Route path='/BoardingPass/:id' component={BoardingPass}/>
          <Route path='/BoardingPassView/:booking_id' component={BoardingPassView}/>
